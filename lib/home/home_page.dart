    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.theater_comedy_outlined), label: "Tiyatro"),
          BottomNavigationBarItem(icon: Icon(Icons.library_books_outlined), label: "Kitap"),
        ],
