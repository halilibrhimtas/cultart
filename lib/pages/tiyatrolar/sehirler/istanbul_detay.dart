...
class IstanbulDetaySayfasi extends StatefulWidget {
  final Tiyatro tiyatro;

  const IstanbulDetaySayfasi({Key? key,  required this.tiyatro}) : super(key: key);

  @override
  _IstanbulDetaySayfasiState createState() => _IstanbulDetaySayfasiState();
}

class _IstanbulDetaySayfasiState extends State<IstanbulDetaySayfasi> {
  @override
