...
class AnkaraDetaySayfasi extends StatefulWidget {
  final Tiyatro tiyatro;
  const AnkaraDetaySayfasi({Key? key, required this.tiyatro}) : super(key: key);

  @override
  _AnkaraDetaySayfasiState createState() => _AnkaraDetaySayfasiState();
}

class _AnkaraDetaySayfasiState extends State<AnkaraDetaySayfasi> {
  @override
